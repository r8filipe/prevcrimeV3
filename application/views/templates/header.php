        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>users"><i class="fa fa-globe"></i><?php echo $this->lang->line('master_menuUsers'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>users/createUser"><i class="fa fa-globe"></i><?php echo $this->lang->line('master_menuCreateUser'); ?></a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
